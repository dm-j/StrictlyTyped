...
public readonly partial record struct ZYX : global::StrictlyTyped.IStrictUShort<ZYX>
{
    ...
    public ZYX([global::System.Diagnostics.CodeAnalysis.DisallowNullAttribute] global::System.UInt16 value)
    {
        Value = value;
    }
    ...
    /// </summary>
    private class Converter : global::StrictlyTyped.StrictTypeConverter<ZYX, global::System.UInt16> { }

    /// <summary>
    /// A JsonConverter for System.Text.Json which converts ZYX transparently to and from Json representations
    /// </summary>
    private sealed class SystemJsonConverter : global::StrictlyTyped.StrictSystemJsonConverter<ZYX, global::System.UInt16> { }
