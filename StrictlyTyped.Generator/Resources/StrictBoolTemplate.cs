...
public readonly partial record struct ZYX : global::StrictlyTyped.IStrictBool<ZYX>
{
    ...
    public ZYX([global::System.Diagnostics.CodeAnalysis.DisallowNullAttribute] global::System.Boolean value)
    {
        Value = value;
    }
    ...
    /// </summary>
    private class Converter : global::StrictlyTyped.StrictTypeConverter<ZYX, global::System.Boolean> { }

    /// <summary>
    /// A JsonConverter for System.Text.Json which converts ZYX transparently to and from Json representations
    /// </summary>
    private sealed class SystemJsonConverter : global::StrictlyTyped.StrictSystemJsonConverter<ZYX, global::System.Boolean> { }
